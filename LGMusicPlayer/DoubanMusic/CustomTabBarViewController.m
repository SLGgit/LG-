...
#define MAIN_COLOR [UIColor colorWithRed:228.0f/255.0f green:72.0f/255.0f blue:119.0f/255.0f alpha:1.0]
...
- (void)createCustomViewControllers
{
    ...
    NSArray *imgArray = [NSArray arrayWithObjects:@"toplist",@"search", nil];
    NSArray *selectedImgArray = [NSArray arrayWithObjects:@"toplist_hover",@"search_hover", nil];
    NSArray *titleArray = [NSArray arrayWithObjects:@"热门",@"搜索", nil];
    CGFloat space = 45.0f;
    for (int i = 0; i < 2; i++) {
