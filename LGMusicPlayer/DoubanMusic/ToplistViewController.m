...
- (void)createOptionView
{
    ...
    NSArray *array = [NSArray arrayWithObjects:@"热门歌曲",@"热门歌手", nil];
...
- (void)buttonClick:(CustomButton *)sender
{
    ...
    if (sender.tag == 250) {
        ...
        if (haVC.view.superview == nil) {
            ...
            haVC.view.frame = (CGRect){myTableView.frame.origin, myTableView.frame.size.width, myTableView.frame.size.height- 49};
